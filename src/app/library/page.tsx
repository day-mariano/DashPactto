        ...
        <div className="flex flex-col w-full ">
          <div className="flex flex-row items-center justify-between w-full pb-4 my-5">
            <div className="flex flex-row items-center">
              ...
              <h1 className="text-[32px] font-bold leading-7">Select a video</h1>
            </div>
            <label
          ...
          <span className="mb-4 text-sm text-[#626262]">Videos uploaded to the reference video library can be used in side-by-side comparisons, or can be shared with learners directly.</span>
