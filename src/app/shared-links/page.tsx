...
const Chats: React.FC = () => {
  ...
  return (
    <>
      ...
      <main id="chats" className={`flex min-h-screen flex-col items-start flex-1 text-white ${
        ...
        <div className="flex flex-col w-full p-8">
          <div className="flex flex-row items-center my-[22px] pb-4">
            ...
            <h1 className="text-[32px] font-bold leading-7">There are no public web links you created
            </h1>
          </div>
        ...
        <div className="flex flex-col w-full p-8">
          <div className="flex flex-row items-center my-[22px] pb-4">
            <h1 className="text-[32px] font-bold leading-7">There are no private web links you created
            </h1>
          </div>
