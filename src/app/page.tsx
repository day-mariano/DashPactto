    ...
    <>
      {isAsideOpen && (
        <aside className="bg-[#2f2f2f] flex flex-col w-[257px] h-screen flex-none">
          <div className="p-8 pb-0">
            <div>
              <div className="flex flex-row justify-between mb-4">
                ...
                />
                <button onClick={closeAside} className="p-1 hover:bg-[#bab8b825] hover:rounded-full">
          ...
          <nav>
            <Link href="/" id="/" className="flex flex-row text-[#BDBDBD] text-sm items-center w-full h-12 px-8 target:bg-[#3a363f] target:text-[#1DBBA5] hover:bg-[#4C4851]">
          ...
          <button className="bg-[#B8B8B8] w-[193px] h-12 m-auto mb-4 rounded-3xl text-[#181818] text-sm font-semibold hover:bg-[#989898]">LOGOUT</button>
        </aside>
      )}
      <main className="flex min-h-screen flex-col items-center p-24 flex-initial">
        {isAsideOpen == false && (
